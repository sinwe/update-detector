...
// serviceName must match install.bat's own
// `sc create update-detector-companion` name exactly -- this is how SCM
// routes its control requests back to this specific process.
const serviceName = "update-detector-companion"
